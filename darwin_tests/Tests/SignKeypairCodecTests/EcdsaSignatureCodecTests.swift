...
/// message `"flutter_sign_keypair known-answer vector"`, selected out of 1200
...
///
/// The same vectors are used by the Kotlin (`DerToP1363Test.kt`) and Dart
/// (`asn1_test.dart`) suites, which cross-validates the three implementations
/// against each other.
